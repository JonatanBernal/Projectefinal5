    ...
    public void foodClicked(final View view) {
        ...
        if (cont == 2) {
            if (id1 == id2) {
                ...
                ImageView aux1 = (ImageView) findViewById(image1);
                aux1.setVisibility(v1.INVISIBLE);
                ImageView aux2 = (ImageView) findViewById(image2);
                ...
                flipper.flipImage(postcard, ((ImageView) findViewById(image1)));
                flipper.flipImage(postcard, ((ImageView) findViewById(image2)));
